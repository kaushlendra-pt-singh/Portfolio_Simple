        ...
        <>
            <section className="flex h-screen w-full flex-col bg-background px-4 py-4 overflow-hidden">
                    ...
                    <Motion.h1
                        ...
                        className="shrink-0 bg-linear-to-br from-slate-800 to-slate-500 dark:from-slate-300 dark:to-slate-500 py-2 bg-clip-text text-center text-3xl font-bold font-heading tracking-tight text-transparent md:text-4xl drop-shadow-[0_0_60px_rgba(56,189,248,0.5)]"
                    >
                        ABOUT ME
                    </Motion.h1>
